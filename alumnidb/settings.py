# Django settings for alumnidb project.
import os
...
SECRET_KEY = '36cqb1pi6)6%bi$@m#5h6qb(q3+x*f(85(#eie44nm%u&amp;b@o-u'
...
ROOT_URLCONF = 'alumnidb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'alumnidb.wsgi.application'
