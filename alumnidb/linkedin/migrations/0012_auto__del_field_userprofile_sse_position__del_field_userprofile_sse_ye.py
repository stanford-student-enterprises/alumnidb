...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.sse_position'
        db.delete_column(u'linkedin_userprofile', 'sse_position')

        # Deleting field 'UserProfile.sse_year'
        db.delete_column(u'linkedin_userprofile', 'sse_year')


    def backwards(self, orm):
        # Adding field 'UserProfile.sse_position'
        db.add_column(u'linkedin_userprofile', 'sse_position',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.sse_year'
        db.add_column(u'linkedin_userprofile', 'sse_year',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
