...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.personal_email'
        db.add_column(u'linkedin_userprofile', 'personal_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.personal_email'
        db.delete_column(u'linkedin_userprofile', 'personal_email')
