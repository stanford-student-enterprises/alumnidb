...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'linkedin_userprofile', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.receive_emails'
        db.add_column(u'linkedin_userprofile', 'receive_emails',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'linkedin_userprofile', 'phone')

        # Deleting field 'UserProfile.receive_emails'
        db.delete_column(u'linkedin_userprofile', 'receive_emails')
