...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_staff'
        db.add_column(u'linkedin_userprofile', 'is_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_staff'
        db.delete_column(u'linkedin_userprofile', 'is_staff')
