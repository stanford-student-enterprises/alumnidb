...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.linkedin_profile_url'
        db.add_column(u'linkedin_userprofile', 'linkedin_profile_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.linkedin_profile_url'
        db.delete_column(u'linkedin_userprofile', 'linkedin_profile_url')
